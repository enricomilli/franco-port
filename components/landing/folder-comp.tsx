      ...
      <HoverCard openDelay={100} closeDelay={0}>
        ...
        >
          <Button
            ...
            variant={"ghost"}
            className="flex flex-col cursor-pointer items-center min-w-22 max-w-40 min-h-24 h-full w-full p-2 "
          >
            {!imageHovered &&
              (folderIcon.src ? (
                <Image
            ...
            <h2 className="min-w-10 text-wrap text-center">{folderName}</h2>
          </Button>
        </HoverCardTrigger>
